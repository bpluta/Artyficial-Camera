...
public struct CameraView: View {
    ...
    private func filterPicker(width: CGFloat) -> some View {
        FilterPickerView(
            ...
            filterPickerDelegate: self.viewModel as? FilterPickerDelegate,
    ...
    private var returnToCaptureModeButton: some View {
        Button(action: {
            ...
            HStack {
                Image(uiImage: #imageLiteral(resourceName: "back_arrow.png"))
    ...
    private var switchCamerasButton: some View {
        Button(action: {
            ...
            Image(uiImage: #imageLiteral(resourceName: "change_camera.png"))
                .renderingMode(.template)
                .resizable()
                .scaledToFit()
                .foregroundColor(Color.white)
    ...
    private var switchImageModeButton: some View {
        Button(action: {
            ...
            Image(uiImage: self.viewModel.imageProcessingMode.icon)
                .renderingMode(.template)
                .resizable()
                .scaledToFit()
                .foregroundColor(Color.white)
