...
enum Filter: CaseIterable {
    ...
    var pickerItemData: FilterPickerItem {
        ...
        case .night:
            return FilterPickerItem(name: "Nocturnal", imageName: "nocturnal.jpg", type: self)
        case .stainedglass:
            return FilterPickerItem(name: "Stained", imageName: "stainedglass.jpg", type: self)
        case .roof:
            return FilterPickerItem(name: "Roof", imageName: "roof.jpg", type: self)
        }
    }
